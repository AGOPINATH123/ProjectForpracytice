			...
			while (YesOrNo == 1) {
			  ...
			  for (int SeatCounter = 0; SeatCounter < SeatNo.length; SeatCounter++) {
			    System.out.printf(SeatCounter + "\t");
			         ...
			         if (SeatCounter == 4) {System.out.println();}
			    else if (SeatCounter == 9) {System.out.println();}
			    else if (SeatCounter == 14){System.out.println();}
			    else if (SeatCounter == 19){System.out.println();}
			    else if (SeatCounter == 24){System.out.println();}
			    else if (SeatCounter == 29){System.out.println();}
			   }
			  for (int k = 1; k <= 34; k++) {System.out.print("*"); }
			  System.out.println();
			  System.out.print("Which seats would you like to book? ");
